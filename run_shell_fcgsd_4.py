...
#         --frame_start 1 --frame_end 300 --test_frame_start 1 --test_frame_end 5 --gof_size 3 \
#         --images images --iterations 8000 --model_path {model_path} --use_first_as_test --dataset meetroom\
...
for lambda_size in lambda_size_list:
    ...
    script = f"python train_fcgsd.py --gpu 1 --eval --joint  --dynamicGS_type 3dgstream_explicit \
        --Q_y 1 --Q_z 1 --lr 1e-3 --lambda_size {lambda_size}  --residual_num 1\
        --conduct_compress --use_scenes \
        --frame_start 1 --frame_end 30 --test_frame_start 1 --test_frame_end 6 --gof_size 1 \
