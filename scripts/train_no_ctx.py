date = '0412'
import os
# lambda_size_list = [1e-3, 1e-4, 1e-5]
...
#         --frame_start 1 --frame_end 300 --test_frame_start 20 --test_frame_end 300 --gof_size 5 --iterations 100\
#         --conduct_training  \
...
for lambda_size in lambda_size_list:
    ...
    script = f"python train_fcgsd.py --gpu 0 --eval --use_scenes --use_gof  --dynamicGS_type control_point\
        ...
        --frame_start 1 --frame_end 300 --test_frame_start 1 --test_frame_end 300 --gof_size 300  --iterations 100\
