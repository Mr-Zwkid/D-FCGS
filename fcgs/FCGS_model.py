...
import math
from fcgs.entropy_models import (Entropy_gaussian, Entropy_gaussian_mix_prob_3,
                                  Entropy_gaussian_mix_prob_2,
                                  Entropy_factorized,
                                  )
from fcgs.grid_utils import normalize_xyz, _grid_creater, _grid_encoder, FreqEncoder
from fcgs.gpcc_utils import sorted_voxels, sorted_orig_voxels, compress_gaussian_params, decompress_gaussian_params
from fcgs.encodings_cuda import (STE_multistep, encoder, decoder,
...
class FCGS(nn.Module):
    ...
    def compress(self, g_xyz, g_fea, means=None, stds=None, testing=True, root_path='./', chunk_size_list=(), determ_codec=False):
        ...
        # print("g_xyz_in", g_xyz)
        g_fea = g_fea[shuffled_indices]  # [N_g, 56]
        # print("g_fea_in", g_fea)
        ...
        #-----#
        g_fea_enc_q_hyp = self.Encoder_fea_hyp(g_fea_enc_q)  # [N_fea, 64]. [95180, 64]
        # print("g_fea_enc_q_hyp",g_fea_enc_q_hyp.shape)##nan
        ...
        print("g_xyz:", g_xyz)
        print("g_fea_out:", g_fea_out)
        print("mask:", mask)
        print("bits (total):", bits/b2M)
        print("bits_xyz:", bits_xyz/b2M)
        print("bits_mask:", bits_mask/b2M)
        print("bits_fea:", bits_fea/b2M)
        print("bits_fea_main:", bits_fea_main/b2M)
        print("bits_fea_hyp:", bits_fea_hyp/b2M)
        print("bits_feq:", bits_feq/b2M)
        print("bits_feq_main:", bits_feq_main/b2M)
        print("bits_feq_hyp:", bits_feq_hyp/b2M)
        print("bits_geo:", bits_geo/b2M)
        print("bits_geo_main:", bits_geo_main/b2M)
        print("bits_geo_hyp:", bits_geo_hyp/b2M)
