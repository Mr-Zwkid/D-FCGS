    ...
    for iteration in range(first_iter, opt.iterations + 1):        
        ...
        for batch_iteraion in range(opt.batch_size):
            ...
            if not viewpoint_stack:
                ...
                # print(len(viewpoint_stack), "cameras in stack")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_iterations", nargs="+", type=int, default=[4000, 5000, 6000, 7_000, 8000, 9000, 10000, 12000, 13000, 15_000, 30_000])
